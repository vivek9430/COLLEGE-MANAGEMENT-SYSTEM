...
Public Class Form6
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        cmd = con.CreateCommand
        cmd.CommandType = CommandType.Text
        cmd.CommandText = "select * from alldetail.about where userid='" + TextBox1.Text + "'"
        cmd.ExecuteNonQuery()
        Dim dt As New DataTable
        Dim da As New MySqlDataAdapter(cmd)
        da.Fill(dt)
    ...
    Private Sub PrintPreviewDialog1_Load_1(sender As Object, e As EventArgs)
    ...
    Private Sub PrintPreviewDialog1_Load_2(sender As Object, e As EventArgs) Handles PrintPreviewDialog1.Load
